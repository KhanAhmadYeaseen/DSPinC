...
int main(){
    ...
    design_lowpass_blackman(h, TAPS, cutoff_freq, FS) ;
    write_signal_into_file("filter_lowpass.dat", h, TAPS) ;
    ...
    write_signal_into_file("mags_af_lowpass.dat", mags_af, BINS_LENGTH) ;
    write_signal_into_file("phs_af_lowpass.dat", phs_af, BINS_LENGTH) ; 
