...
int main(){
    ...
    design_highpass_blackman(h, TAPS, cutoff_freq, FS) ;
    write_signal_into_file("filter_highpass.dat", h, TAPS) ;
    ...
    write_signal_into_file("output_highpass.dat", output, SIG_LENGTH) ;
    ...
    write_signal_into_file("mags_af_highpass.dat", mags_af, BINS_LENGTH) ;
    write_signal_into_file("phs_af_highpass.dat", phs_af, BINS_LENGTH) ; 
